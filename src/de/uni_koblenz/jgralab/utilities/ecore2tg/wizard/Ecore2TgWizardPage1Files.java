 ...
 * 
 */
public class Ecore2TgWizardPage1Files extends WizardPage {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (path != null) {
					...
					if (Ecore2TgWizardPage1Files.this.isComplete()) {
						Ecore2TgWizardPage1Files.this.setPageComplete(true);
					}
				} else {
					Ecore2TgWizardPage1Files.this.setPageComplete(false);
				}
			}
		});
	}
	...
	private void createEnterEcoreModelControls() {
		...
		buttonSelectEcoreModel.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (path != null) {
					Ecore2TgWizardPage1Files.this.textXMIFile.setText(path);
				}
			}
		});
	}
	...
	private void createEnterTargetTgFileControls() {
		...
		buttonSelectTargetFolder.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (path != null) {
					Ecore2TgWizardPage1Files.this.textTgFile.setText(path);
					if (Ecore2TgWizardPage1Files.this.isComplete()) {
						Ecore2TgWizardPage1Files.this.setPageComplete(true);
					}
				} else {
	...
	private void createChooseDefaultOptionsControls() {
		...
		this.buttonDefaultOptions.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (b.getSelection()) {
					Ecore2TgWizardPage1Files.this.buttonUseConfigFileCheck
							.setEnabled(false);
				} else {
					Ecore2TgWizardPage1Files.this.buttonUseConfigFileCheck
							.setEnabled(true);
				}
				Ecore2TgWizardPage1Files.this
						.setPageComplete(Ecore2TgWizardPage1Files.this
								.isPageComplete());
			}
		});
		...
		this.buttonUseConfigFileCheck
				.addSelectionListener(new SelectionAdapter() {
					...
					public void widgetSelected(SelectionEvent e) {
						Button b = (Button) e.widget;
						if (b.getSelection()) {
							Ecore2TgWizardPage1Files.this.buttonDefaultOptions
									.setEnabled(false);
						} else {
							Ecore2TgWizardPage1Files.this.buttonDefaultOptions
									.setEnabled(true);
		...
		this.buttonConfigFileBrowse
				.addSelectionListener(new SelectionAdapter() {
					...
					public void widgetSelected(SelectionEvent e) {
						...
						if (path != null) {
							Ecore2TgWizardPage1Files.this.textConfigFile
									.setText(path);
						}
						Ecore2TgWizardPage1Files.this
								.setPageComplete(Ecore2TgWizardPage1Files.this
